...
| :---- | :------------------- | :------- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | :----------------------------------------- | :---------------- |
| **1** | Lê Gia Bảo           | 23127325 | - Phụ trách tính năng Che giấu dữ liệu (Data Masking) <br> - Kết hợp thư viện `Faker.js` cho các trường phẳng và `Gemini AI` cho các JSON lồng nhau. <br> - Viết Phần 5: Troubleshooting (Khắc phục sự cố) trong `User_Guide.md`, làm tài liệu hướng dẫn cho các lỗi cài đặt và lỗi runtime thường gặp trong quá trình làm dự án.<br>- Nghiên cứu các lỗi cấu hình để đưa ra các bước khắc phục sự cố chính xác và đáng tin cậy. <br>- Quay các video demo minh họa cách nhận diện và giải quyết từng vấn đề trong môi trường phát triển thực tế.                                                                                                                                                                                                                                                                                                                                                                                     | Tích cực và hoàn thành tốt, đúng thời hạn. | **100%**          |
| **2** | Hồ Gia Huy           | 23127376 | - Phụ trách phần Mở đầu & Tổng quan Seminar <br> - Giới thiệu tầm quan trọng của Database Testing và hai công cụ cốt lõi (`migrate-mongo`, Gemini AI). <br> - Viết Phần 3: First Test (Migration & Rollback) trong `User_Guide.md`, trình bày chi tiết từng bước quy trình chạy migrations cho cơ sở dữ liệu và thực hiện rollback thành công để đảm bảo toàn vẹn dữ liệu. <br>- Sản xuất và quay video demo chuyên sâu nhằm hướng dẫn trực quan cho người dùng về cách áp dụng thực tế các quy trình migration và rollback, đảm bảo tính rõ ràng và dễ hiểu.                                                                                                                                                                                                                                                                                                                                                                         | Tích cực và hoàn thành tốt, đúng thời hạn. | **100%**          |
| **3** | Trần Phạm Trọng Nhân | 23127443 | - Phát triển giải pháp Kiểm thử Toàn vẹn (Business Invariants Testing) <br> - Đóng gói quy trình thành Agent Skill cho AI để tự động sinh test case. <br> - Cập nhật bản đề xuất (proposal) với các công cụ mới (`migrate-mongo` thay cho Liquibase, Proshop-v2 thay cho EShop) để phù hợp với yêu cầu kiểm thử cơ sở dữ liệu NoSQL.<br>- Viết Phần 2: Install (Cài đặt) trong `User_Guide.md`, bao gồm hướng dẫn từng bước để cài đặt MongoDB Atlas, cấu hình `migrate-mongo`, và chuẩn bị môi trường.<br>- Quay video demo minh họa quá trình cài đặt và sử dụng công cụ.                                                                                                                                                                                                                                                                                                                                                           | Tích cực và hoàn thành tốt, đúng thời hạn. | **100%**          |
| **4** | Trần Thanh Trí       | 23127503 | - Nghiên cứu tích hợp `migrate-mongo` (Quản lý phiên bản) <br> - Xây dựng script sinh dữ liệu biên bằng AI <br> - Thiết kế kịch bản Live Demo. <br> - Cập nhật Phần 3 của bản đề xuất (proposal).<br> - Phát triển script sinh dữ liệu tổng hợp với sự hỗ trợ của AI (`generate_test_data.js`) sử dụng API Google Gemini để tự động chèn các test case biên (boundary) và tiêu cực (negative).<br> - Triển khai module Che giấu Dữ liệu Thông minh (`masking_data.js`) kết hợp thư viện Faker.js và Gemini AI để bảo vệ thông tin định danh cá nhân (PII) dựa trên ngữ cảnh.<br> - Xây dựng bộ Kiểm thử Toàn vẹn Nghiệp vụ toàn diện (`test_invariants.js`) sử dụng MongoDB Aggregation Pipelines để xác thực 10 quy tắc nghiệp vụ quan trọng (VD: dữ liệu mồ côi, logic tài chính, tính nhất quán của trạng thái).<br> - Soạn thảo và quay video demo cho tài liệu kỹ thuật, cụ thể là Phần 4: Advanced Usage trong `User_Guide.md`. | Tích cực và hoàn thành tốt, đúng thời hạn. | **100%**          |
