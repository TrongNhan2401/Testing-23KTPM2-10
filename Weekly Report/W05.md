...
- Authored slide content for the Integrity Testing (Kiểm thử Toàn vẹn) section, covering both the pain points of writing invariant tests by hand and the Agent Skill–based solution for auto-generating tests.
- Designed and documented the `test_invariants_skill.md` workflow that packages the NoSQL invariant testing procedure into a reusable AI Agent skill, including reading the real schema, placing the orphan-check in the correct referencing collection, running through `runAllInvariants.js`, and a final self-checklist.
- Supported writing the in-class activity scripts (Spot-the-PII game setup, answer-key coordinates, scoring mechanism) in coordination with the Data Masking section.

### Evidence

- Documents:
  - Slide_Content.md (Session 3. Kiểm thử Toàn vẹn)
  - In-class_Activity.md
- Other Artifacts:
  - Slide: database-testing-slides.html
  - test_invariants_skill.md
